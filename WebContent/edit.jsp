...
<script>
	$(function() {
		$(".inp_radio").click(function() {
			if ($(this).val() == 't') {
				$(".member_num").show();
				$(".member_num").addClass("lineBottom");
				$(".mem_link").removeClass("lineBottom");
			} else {
				$(".member_num").hide();
				$(".mem_link").addClass("lineBottom");
				$(".member_num").removeClass("lineBottom");
			}
		});
	});
</script>
								...
								<div class="card-body">
									<div class="notice_bx" style="width: 825px; margin: 0 auto;">
										<table class="detailTable" id="detailTable">
											...
											<tr class="lineTop">
												<th>구분</th>
												<td class="ve"><input checked type="radio"
													name="member_bool" value="t" class="inp_radio" id="boolX" /><label
													for="boolX" style="margin-right: 20px">임원</label><input
													type="radio" name="member_bool" value="f" class="inp_radio"
													id="boolO" /><label for="boolO">회장</label></td>
											</tr>
											<tr>
												<th>사진</th>
											...
											<tr>
												...
												<td><input type="text" class="form-control"
													name="notice_title"
													placeholder="전화번호( 숫자만 입력 ) 또는 이메일( ex: abc@naver.com )"
													required></td>
											</tr>
											<tr>
												<th>소속회사</th>
