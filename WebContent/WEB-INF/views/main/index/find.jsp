							...
							<div class="joinform_wrap">
								...
								<div class="item">
									<dl class="line-full">
										...
										<dd>
											<input type="text" name="u_name" id="u_name" value="" pattern="^[가-힣a-zA-Z]{1,20}$"
												data-parsley-errors-container="span[id='nameError']" data-parsley-required="true"
												data-parsley-trigger="change" required placeholder="영문 , 한글만  입력" />
										</dd>
									</dl>
								...
								<div class="item">
									<dl class="line-full">
										...
										<dd>
											<input type="text" name="u_name" id="u_name" value="" placeholder="영문 , 한글만  입력"
